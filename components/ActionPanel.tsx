...
const ActionPanel: React.FC<ActionPanelProps> = ({ 
  ...
  if (isSelectingFreeRecruitHex && freeRecruitType) {
    return (
      <div className={`w-full max-w-4xl mx-auto p-5 bg-slate-950/90 backdrop-blur-xl rounded-t-2xl border-t-2 border-x-2 ${theme.border} flex flex-col items-center shadow-2xl relative overflow-hidden`} style={factionStyles}>
  ...
  if (isSelectingCombatHex) {
    return (
      <div className={`w-full max-w-4xl mx-auto p-5 bg-slate-950/90 backdrop-blur-xl rounded-t-2xl border-t-2 border-x-2 border-red-500/40 flex flex-col items-center shadow-2xl relative overflow-hidden`}>
  ...
  if (isSelectingAdventureHex) {
    return (
      <div className={`w-full max-w-4xl mx-auto p-5 bg-slate-950/90 backdrop-blur-xl rounded-t-2xl border-t-2 border-x-2 border-amber-500/40 flex flex-col items-center shadow-2xl relative overflow-hidden`}>
  ...
  if (isExploring) {
    return (
      <div className={`w-full max-w-4xl mx-auto p-5 bg-slate-950/90 backdrop-blur-xl rounded-t-2xl border-t-2 border-x-2 border-emerald-500/40 flex flex-col items-center shadow-2xl relative overflow-hidden`}>
  ...
  if (isRecruiting) {
    if (!recruitingUnitType) {
      return (
        <div className={`w-full max-w-4xl mx-auto p-5 bg-slate-950/95 backdrop-blur-xl rounded-t-2xl border-t-2 border-x-2 ${theme.border} flex flex-col items-center shadow-2xl relative overflow-hidden`} style={factionStyles}>
          <div className="absolute top-0 left-0 w-full h-1 opacity-50" style={{ backgroundColor: theme.color }}></div>
  ...
  return (
    <div className={`w-full max-w-4xl mx-auto p-4 bg-slate-950/90 backdrop-blur-2xl rounded-t-2xl border-t-2 border-x-2 ${theme.border} flex flex-col items-center shadow-2xl relative overflow-hidden`} style={factionStyles}>
      {/* Faction Accent line */}
