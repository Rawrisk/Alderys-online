...
export interface Quest {
  id: string;
  description: string;
  type: 'SPEND_GOLD' | 'SPEND_XP' | 'ADDED_SKILLS' | 'CASTLES' | 'ADVENTURES' | 'MONSTERS' | 'ENEMY_UNITS' | 'LEVEL_3_SKILLS' | 'LEVEL_2_SKILLS' | 'PVP_LEVEL_3_UNIT' | 'UNIT_COMPOSITION' | 'PVP_DAMAGE' | 'CONTROL_HEXES' | 'PVP_DEFENSE' | 'UNITS_IN_OLD_CITY' | 'BUILD_CASTLES' | 'DEFEAT_MONSTERS';
  requirement: any;
  rewardVP: number;
}
